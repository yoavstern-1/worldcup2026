...
+ '.bk-team .bp{font-size:10px;font-weight:700;color:var(--gold);padding-inline-start:3px;}'
+ '.bk-div{height:1px;background:var(--card-border);}'
+ '.bk-ph .bk-team{opacity:.55;}'
+ '.bk-when{font-size:9px;color:var(--t3);padding:2px 7px;text-align:center;border-top:1px solid var(--card-border);}'
+ '.bk-note{font-size:9px;color:var(--gold);padding:1px 6px;}'
...
+ '@media(max-width:600px){.bk{min-width:760px}.bk-trophy-col{width:64px}.bk-title{font-size:11px}.bk-team{font-size:10px}}';
